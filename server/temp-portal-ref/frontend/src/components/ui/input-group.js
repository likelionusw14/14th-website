...
const inputGroupAddonVariants = (0, class_variance_authority_1.cva)("text-muted-foreground h-auto gap-2 py-1.5 text-sm font-medium group-data-[disabled=true]/input-group:opacity-50 [&>kbd]:rounded-[calc(var(--radius)-5px)] [&>svg:not([class*='size-'])]:size-4 flex cursor-text items-center justify-center select-none", {
    variants: {
        align: {
...
const inputGroupButtonVariants = (0, class_variance_authority_1.cva)("gap-2 text-sm shadow-none flex items-center", {
    variants: {
        size: {
